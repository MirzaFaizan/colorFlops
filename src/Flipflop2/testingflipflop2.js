...
import SvgComponents from './flipflop2svg'
...
export default function FullWidthGrid(props) {
  ...
  const [colorStrap2,setColorStrap2] = React.useState('#008000');
 ...
 */}
        ...
        <Grid item xs={12} sm={6} style={{textAlign:'center'}}>
             ...
             {/* SVG */}
             <SvgComponents sole={colorSole} strap={colorStrap} strap2={colorStrap2}></SvgComponents>
...
*/}
        ...
        <br/><br/>
          ...
          <Grid item xs={12} sm={4}>
          <Typography component="div"  style={{ fontSize:'20px'}} > Flipflop - 02 </Typography>
          ...
          <Button variant="contained" color="primary"  style={{ textAlign:'center', fontSize:'15px', width:'45%',height:'70%'}} className={classes.button}
            onClick={()=>{window.location=`/buy/${colorSole}/${colorStrap}/${quant}/${size}/${price}/${'FlipFlop-02'}/${colorStrap2}`}}>
            Buy
          </Button>
          </Grid>
          <Grid style={{ textAlign:'center'}} item xs={12} sm={6}>
